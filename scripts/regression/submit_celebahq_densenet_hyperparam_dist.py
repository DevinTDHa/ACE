...
dist_l1s = [0.01, 0.001, 0.0001]
dist_l2s = [0.01, 0.001, 0.0001]
...
for dist_l1, dist_l2 in [(dl1, 0) for dl1 in dist_l1s] + [(0, dl2) for dl2 in dist_l2s]:
    command = f"echo scripts/regression/run_age_celebahq.sh {attack_method} {attack_step} {dist_l1} {dist_l2} {rmodel_path}"
    os.system(command)
